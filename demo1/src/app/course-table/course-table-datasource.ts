...
const EXAMPLE_DATA: CourseTableItem[] = [
  {id: 1, name: 'Hydrogen', weeks: 5},
  {id: 2, name: 'Helium', weeks: 6},
  {id: 3, name: 'Lithium', weeks: 7},
  {id: 4, name: 'Beryllium', weeks: 9},
  {id: 5, name: 'Boron', weeks: 8},
  {id: 6, name: 'Carbon', weeks: 5},
  {id: 7, name: 'Nitrogen', weeks: 1},
  {id: 8, name: 'Oxygen', weeks: 2},
  {id: 9, name: 'Fluorine', weeks: 3},
];
